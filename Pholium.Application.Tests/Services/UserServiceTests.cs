...
namespace Pholium.Application.Tests.Services
{
    public class UserServiceTests
    {
        ...
        {
            var ex = Assert.Throws<Exception>(() => userService.Post(new UserViewModel { ID = Guid.NewGuid() }));
            Assert.Equal("UserID must be empty!", ex.Message);
        }
